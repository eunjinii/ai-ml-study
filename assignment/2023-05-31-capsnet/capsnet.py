# Modified CapsNet code by adambielski | https://github.com/adambielski/CapsNet-pytorch.git
...
class CapsNet(nn.Module):
    def __init__(self, routing_iterations, n_classes=10):
        ...
        self.primaryCaps = PrimaryCaps(256, 32, 8, kernel_size=9, stride=2)  # outputs 6*6
        self.num_primaryCaps = 32 * 6 * 6
        routing_module = DynamicRouting(self.num_primaryCaps, n_classes, routing_iterations)
        self.digitCaps = DigitCaps(self.num_primaryCaps, 8, n_classes, 16, routing_module)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--routing_iterations', type=int, default=8)
    ...
    torch.save(model.state_dict(),
                'model_dict_{}epochs_{}routing_reconstruction_{}.pth'.format(args.epochs, args.routing_iterations,
